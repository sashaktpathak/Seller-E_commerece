...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <!-- left sidebar -->
        <!-- ============================================================== -->
        <div class="nav-left-sidebar sidebar-dark" id="sbr">
            <div class="menu-list">
            ...
            <div class="container-fluid  dashboard-content">
                                ...
                                <form class="needs-validation" novalidate>
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="text" class="form-control" id="category_code" placeholder="EH01"  required>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="text" class="form-control" id="category" placeholder="Electronics" required>
                                            <br>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                            <button class="btn btn-primary" id ="addcat" type="button">Submit form</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Create New Sub Category</h5>
                            <div class="card-body">
                                <form action="#" id="basicform" data-parsley-validate="">
                                    <div class="form-group">
                                        ...
                                        <?php 
                                                ...
                                                echo "  
                                                <select class='form-control' id=category_code_dd name=category_code_dd>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail">New Sub Category Name</label>
                                        <input type="email" name="email" data-parsley-trigger="change"
                                            required="" placeholder="Eg: Mobile" id="sub_cat" autocomplete="off" class="form-control">
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 pl-0">
                                            <p class="text-right">
                                                <button type="submit" id="subcatbtn" class="btn btn-space btn-primary">Submit</button>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Create New Sub Sub Category</h5>
                            <div class="card-body">
                                <form action="#" id="basicform" data-parsley-validate="">
                                    <div class="form-group">
                                        <label for="inputUserName">Select Category</label>
                                        <?php 
                                                ...
                                                $sql="select * from category";
                                                echo "  
                                                <select class='form-control' id=category_code_subsub name=category_code>
                                                    <option value=''>Select One</option>";
                                                        foreach ($conn->query($sql) as $row) {
                                                        echo "<option value='$row[category_code]'>$row[category]</option>";
                                                        }
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail">Select Sub Category Name</label>
                                        <select class='form-control' id=sub_id2 name=sub_id><option value=''>Select sub-category</option></select>
                                    </div>
                                    <div class="form-group">
                                        <label for="ssub_id2">New Sub Sub Category Name</label>
                                        <input id="ssub_id2" type="email" name="email" data-parsley-trigger="change"
                                            required="" placeholder="Eg: Mobile" autocomplete="off" class="form-control">
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 pl-0">
                                            <p class="text-right">
                                                <button type="submit" class="btn btn-space btn-primary" id="subsubcatbtn">Submit</button>
                                                <button class="btn btn-space btn-secondary">Cancel</button>
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <form id="validationform" data-parsley-validate="" novalidate="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" required="" data-parsley-length="[5,10]" placeholder="Text between 5 - 10 chars length"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                            ...
                                            <div class="custom-controls-stacked">
                                                <label class="custom-control custom-checkbox">
                                                    <input id="ck1" name="ck1" type="checkbox" data-parsley-multiple="groups"
                                                        ...
                                                        data-parsley-errors-container="#error-container1" class="custom-control-input"><span
                                            ...
                                            <div class="custom-controls-stacked">
                                                ...
                                                <label class="custom-control custom-checkbox">
                                                    <input type="checkbox" value="bar" id="e3" data-parsley-multiple="group1"
                                                        ...
                                                        class="custom-control-input"><span class="custom-control-label">Option
                                                        3</span>
                                                </label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="email" required="" data-parsley-type="email" placeholder="Enter a valid e-mail"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
    ...
    <script>
        $('#addcat').click(function(){
            $.post( "addcategory.php", {"category_code":$('#category_code').val(),"category":$('#category').val()},function(return_data,status){
                console.log("fgb");
                if(return_data.db_status=='OK'){
                    console.log("23");
                        window.location = "form-validation.php";
                }
                else
                {
                    console.log("243");
        ...
        $('#subcatbtn').click(function(){
            $.post( "addsubcategory.php", {"cat_code":$('#category_code_dd').val(),"sub_cat":$('#sub_cat').val()},function(return_data,status){
                if(return_data.db_status=='OK'){
                    window.location = "form-validation.php";
                }
            },'json');
        });
        $("#category_code_subsub").change(function(){ // change function of listbox
        $("#sub_id2").empty();
        $.post( "dropdown3ck.php", {"category_code":$('#category_code_subsub').val()},function(return_data,status){
        $("#sub_id2").append("<option value=''>Select One</option>");

        $.each(return_data.sub, function(key,value){
        $("#sub_id2").append("<option value=" + value.sub_id +">"+value.sub_id + ':' + value.sub+"</option>");
        });

        },"json");
        });
        $('#subsubcatbtn').click(function(){
            $.post( "addsubsubcategory.php", {"cat_code":$('#category_code_subsub').val(),"sub_cat":$('#sub_id2').val(),"sub_cat":$('#ssub_id2').val()},function(return_data,status){
                if(return_data.db_status=='OK'){
                    window.location = "form-validation.php";
                }
            },'json');
